...
string V_MODEL = "models/ins2/wpn/m21/v_m21.mdl";
...
uint SLOT       	= 7;
uint POSITION   	= 7;
float RPM_AIR   	= 0.185f; //Rounds per minute in air
...
class weapon_ins2m21 : ScriptBasePlayerWeaponEntity, INS2BASE::WeaponBase
{
	...
	bool Deploy()
	{
		...
		{
			m_WasDrawn = true;
			return Deploy( V_MODEL, P_MODEL, DRAW_FIRST, "sniper", GetBodygroup(), (94.0/36.0) );
		}
		else
			return Deploy( V_MODEL, P_MODEL, (self.m_iClip == 0) ? DRAW_EMPTY : DRAW, "sniper", GetBodygroup(), (22.0/31.0) );
	}
	...
	void Reload()
	{
		...
		{
			(self.m_iClip == 0) ? Reload( MAX_CLIP, RELOAD_EMPTY, (182.0/37.0), GetBodygroup() ) : Reload( MAX_CLIP, RELOAD, (135.0/37.0), GetBodygroup() );
			canReload = false;
		}
